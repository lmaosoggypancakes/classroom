...
(function ($) {
  ...
  function createCalendar(month, year, options) {
    ...
    var _frame = $('<table>').addClass('current');

    var frameBody = $('<tbody>').appendTo(_frame);
    ...
    $('td:empty', _frame).addClass('disabled');

    if (currentMonth === new Date().getMonth()) {
      $('td', _frame).filter(function () {
